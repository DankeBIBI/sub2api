...
var providerPendingOrderProtectedConfigFields = map[string]map[string]struct{}{
	...
	// offerId 是虚拟支付的商户身份(已快照进订单),products 决定旧单的
	// 面额→道具映射,改掉都会让在途订单查单/发货失真。
	payment.TypeWechatXpay: {"offerid": {}, "appkey": {}, "products": {}},
}
